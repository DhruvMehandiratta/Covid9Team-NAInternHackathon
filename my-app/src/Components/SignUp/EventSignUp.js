        ...
        <>
            ...
            <div style={{height: "100%", position: "fixed", zIndex:"1", top: 100, left:180, width:"50%", marginTop: "100px"}}>
                <form>
                    ...
                    <input style={{fontSize:"25px", borderRadius: "10px", backgroundColor: "Gainsboro", fontFamily: "Poppins",height:"50px", width:"300px"}} type="password" id="event_desc"></input><br/><br/><br/>
